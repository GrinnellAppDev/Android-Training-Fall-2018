...
public class Test {
	...
	private static String getAnswer = "Enter answer here: ";
	...
	public static void printScore() {
		...
		System.out.println("TOTAL SCORE: " + totalCorrect + "/" + totalQuestions);
	...
	public static void init(String[] args) {
		...
		System.out.println(SPACE);
		System.out.print("Enter A, B, C, or D to answer (case insensitive). \n");
